...
IMAGE = "engulf-clab.pki-linux-debian/installer:latest"
PROVIDER_ID = "engulf_clab.pki_linux_debian.images"
...
SCHEMA = (
    PluginSchema("engulf_clab.pki_linux_debian", package="engulf_clab_pki_linux_debian")
    .use_case("Build the Debian-family Linux PKI installer asset.")
    .refer("USAGE.md")
)
class Plugin(SchemaBackedPlugin):
    plugin_id = "engulf_clab.pki_linux_debian"
    schema = SCHEMA
