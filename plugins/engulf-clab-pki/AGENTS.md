...
- Generate and stage only in preparation and journal work. Unwind preparation and pre-spawn failures; retain views after a started deploy fails so partial containers remain safe until destroy.
