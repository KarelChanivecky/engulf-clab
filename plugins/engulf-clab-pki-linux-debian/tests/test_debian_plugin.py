...
from engulf_clab_pki_linux_debian.plugin import IMAGE, PROVIDER_ID, image_plugin, plugin
...
def test_registers_provider_with_wrapper_application() -> None:
    ...
    with patch("engulf_clab_pki_linux_debian.plugin.record_plugin_schema"):
