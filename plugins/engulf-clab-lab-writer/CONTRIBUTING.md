...
derived topology. The writer materializes once during preparation, preserves
YAML key order where possible, and owns only its recognizable generated and
staged paths. Feature-specific state, leases, validation, and mutation logic
remain with the mutator.
